...
### Three Pillars
```
LOGS    → What happened (events, step-by-step)
METRICS → How much (numbers, trends)
TRACES  → Full journey (request path, timing)
```

### What to Track

**Agent Level:**
- Session ID, task, outcome, duration, tokens, cost

**Loop Level:**
- Iteration #, thought, action, tool called, result

**Metadata:**
- User ID, tier, environment, agent version
...
```
MONITORING: "Is it working?" (yes/no)
OBSERVABILITY: "Why is it behaving this way?" (deep understanding)
```
...
| Tool | Best For |
|------|----------|
| **Honeycomb** | AI/ML apps, high-cardinality data |
| **Datadog** | All-in-one enterprise |
...
| Observability | [04-Building-Agents/05-Observability.md](04-Building-Agents/05-Observability.md) |
